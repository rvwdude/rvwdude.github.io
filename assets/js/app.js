...
(0, _jquery2.default)('.form__date').datepicker({
  autoClose: true,
...
app.topMenu = function () {
  ...
  (0, _jquery2.default)(".dropdown").on('show.zf.dropdownmenu', function (ev, $el) {
    $el.css({
      "display": "none"
    }).slideDown(200);
  });

  (0, _jquery2.default)(".dropdown").on('hide.zf.dropdownmenu', function (ev, $el) {
    $el.children("ul").css('display', 'inherit').slideUp(100);
  });
};
...
(0, _jquery2.default)('.docs').slick({
  dots: false,
  infinite: false,
  speed: 300,
  slidesToShow: 4,
  slidesToScroll: 1,
  appendArrows: '.docs__nav',
...
(0, _jquery2.default)('.single-item').slick({
  dots: true,
  arrows: false,
  autoplay: true
});
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)('.testimonials').owlCarousel({
    items: 1,
    dots: false
  });
});
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)('.hero-slider').owlCarousel({
    items: 1,
    dots: true
  });
});
...
// COUNT UP
(0, _jquery2.default)('.count__number').counterUp({
  delay: 10,
  time: 1000
});
...
(0, _jquery2.default)('.parallax-hero').parallax({ imageSrc: '../assets/img/hero-bkg-01.jpg' });
